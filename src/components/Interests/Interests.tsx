...
const interests = [
    ...
    {
        category: "Music",
        text: "Taylor Swift, The Maine, Halsey, Bishop Briggs, K Flay, The Pixies, The Cure, Mudvayne, Neutral Milk Hotel, Doja Cat, Brian Jonestown Massacre",
    },
    { category: "Movies", text: "Evil Dead, Just Friends, Mean Girls, Bad Teacher, She's The Man, Death Proof" },
    {
        category: "TV",
        text: "Abbott Elementary, The Good Doctor, Buffy The Vampire Slayer, 90 Day Fiance, Love Island, Degrassi, Yellowjackets ...a bunch more",
    },
                ...
                <tbody className='p-2'>
                    {interests.map((interest, index) => (
                        <tr key={index} className='border-4 border-white'>
                            ...
                            <td className='py-2 px-3 text-normal text-left text-black bg-[#D7E6FA]'>{interest.text}</td>
                        </tr>
                    ))}
                </tbody>
            </table>
